...
{
    private List<TimerForCoord> time =  new ArrayList<>();
	private static final AxisAlignedBB cactussmall = new AxisAlignedBB(0.375D, 0.0D, 0.375D, 0.625D, 0.31D, 0.625D);

	public CactusSmall(Material materialIn, String name, float hardness, float resistanse, String hravLevel, int level, SoundType soundtype)
    {
