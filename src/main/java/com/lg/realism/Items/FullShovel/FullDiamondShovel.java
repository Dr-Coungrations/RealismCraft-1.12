...
public class FullDiamondShovel extends DevBasicItem{

	public FullDiamondShovel(String name, int maxStackSize) {
	...
	public EnumActionResult onItemUse(EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		player.setHeldItem(EnumHand.MAIN_HAND, new ItemStack(Items.DIAMOND_SHOVEL));
