...
public class BreakBirchGen extends WorldGeneratorOne {
			...
			if(world.getBiome(new BlockPos(pos.getX(), world.getActualHeight(), pos.getZ())) == Biomes.BIRCH_FOREST 
				...
				if (world.isAirBlock(pos) && world.getBlockState(pos.down()).getBlock() == Blocks.GRASS) {
					if(variator == 0) {
						...
						for(int j = 2; i < rand.nextInt(6); ++i){
							world.setBlockState(new BlockPos(pos.getX(), pos.getY(), pos.getZ() + j),Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.BIRCH).withProperty(LOG_AXIS, BlockLog.EnumAxis.Z));
							world.setBlockState(new BlockPos(pos.getX(), pos.getY() + 1, pos.getZ() + j),RegBlocks.mossblock.getDefaultState());
						}
					}
					if(variator == 1) {
						world.setBlockState(new BlockPos(pos),Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.BIRCH).withProperty(LOG_AXIS, BlockLog.EnumAxis.Y));
					...
					if(variator == 2) {
						world.setBlockState(new BlockPos(pos),Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.BIRCH).withProperty(LOG_AXIS, BlockLog.EnumAxis.Y));
						for(int j = 2; i < rand.nextInt(6); ++i){
							world.setBlockState(new BlockPos(pos.getX() - j, pos.getY(), pos.getZ()),Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.BIRCH).withProperty(LOG_AXIS, BlockLog.EnumAxis.X));
							world.setBlockState(new BlockPos(pos.getX() - j, pos.getY() + 1, pos.getZ()),RegBlocks.mossblock.getDefaultState());
						}
					}
					if(variator == 3) {
						world.setBlockState(new BlockPos(pos),Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.BIRCH).withProperty(LOG_AXIS, BlockLog.EnumAxis.Y));
