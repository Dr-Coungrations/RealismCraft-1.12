...
public class UnbreakBlock {
	...
	private static boolean canBlockItemPickaxe(ItemStack itemStack) {
		return itemStack == null || !(itemStack.getItem() instanceof ItemPickaxe || itemStack.getItem() instanceof ItemRealPickaxe);
	}
	private static boolean canBlockItemAxe(ItemStack itemStack) {
		return itemStack == null || !(itemStack.getItem() instanceof ItemAxe || itemStack.getItem() instanceof ItemRealPickaxe);
	}
}
